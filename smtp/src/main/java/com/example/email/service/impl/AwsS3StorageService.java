...
public class AwsS3StorageService implements StorageService {
    ...
    @Override
    public boolean canConnectToBucket(String bucketName) {
        try {

            client.listObjectsV2(builder -> builder.bucket(bucketName));
            System.out.println("Successfully connected to the bucket: " + bucketName);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
